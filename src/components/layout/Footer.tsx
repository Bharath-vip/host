...
import { Sparkles, MessageCircle, Code, Briefcase, ArrowRight } from 'lucide-react';
          ...
          <div>
            ...
            <form className="flex flex-col gap-2">
              <Input 
                ...
                className="bg-card/50 border-white/10 text-white placeholder:text-muted-foreground focus-visible:ring-primary"
              />
